...
parser.add_argument('--author-output-path', type=str,default='dataset/author.npy',
...
parser.add_argument('--graph-output-path', type=str, default='dataset/Graph.dgl',
                    help='Path to store the graph.')
parser.add_argument('--graph-as-homogeneous', action='store_true',default=True,
